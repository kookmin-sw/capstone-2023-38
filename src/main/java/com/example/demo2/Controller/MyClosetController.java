...
public class MyClosetController {
    ...
    public String uploadTopImagesToBucket(
        ...
        return functions.uploadImagesS3andMysql(files, userId, MyCloset.ClothingCategory.TOP, bucket4_top);
    }
    ...
    public String uploadBottomImagesToBucket(
        ...
        return functions.uploadImagesS3andMysql(files, userId, MyCloset.ClothingCategory.BOTTOM, bucket4_bottom);
    }
    ...
    public String uploadShoesImagesToBucket(
        ...
        return functions.uploadImagesS3andMysql(files, userId, MyCloset.ClothingCategory.SHOES, bucket4_shoes);
    }
    ...
    public String uploadAccessoryImagesToBucket(
        ...
        return functions.uploadImagesS3andMysql(files, userId, MyCloset.ClothingCategory.ACCESSORY, bucket4_accessory);
    }
}
